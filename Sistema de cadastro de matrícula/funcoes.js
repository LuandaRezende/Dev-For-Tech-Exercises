$(function () {
    ...
    function Adicionar() {
        ...
        var cliente = JSON.stringify({
            ...
            Email: $("#txtEmail").val(),
            DtCad: $("#txtDtCad").val(),
            DtCadSug: $("#txtDtCadSug").val(),
            HoraCad: $("#txtHora").val(),
            HoraSug: $("#txtHoraSug").val(),
            Curso: $("#curso").val(),
        });
    ...
    function Listar() {
        ...
        for (var i in tbClientes) {
            if (tbClientes[i]) {
                ...
                var dtfinalSug = cli.DtCadSug.substring(8, 10) + "/" + cli.DtCadSug.substring(5, 7) + "/" + cli.DtCadSug.substring(0, 4);
    ...
    $("#tblListar").on("click", ".btnEditar", function () {
        ...
        $("#txtDtCadSug").val(cli.DtCadSug);
        $("#txtHora").val(cli.HoraCad)
        $("#txtHoraSug").val(cli.HoraSug);
    ...
    $("#txtDtCadSug").val(str_data_Brazil);
    $("#txtHoraSug").val(hora_geral);
});
